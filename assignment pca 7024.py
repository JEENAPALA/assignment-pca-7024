...
Original file is located at
    https://colab.research.google.com/drive/1jAxVAVL7Wh8wBG2iXjgr-h85B1TR2sid
...
#load dataset
d=pd.read_csv('/content/drive/My Drive/PCA_practice_dataset.csv')
d.head()
X=d.to_numpy()
X.shape
